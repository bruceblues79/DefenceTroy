...
export default function BattleFieldSpace() {
  return (
    <group>
      ...
      <mesh name="ground" position={[0, 0, 0]} rotation={[-Math.PI / 2, 0, 0]}>
        <planeGeometry args={[5, 9]} />
        <meshBasicMaterial color="#d4c4a0" />
      </mesh>

      {/* wall: box 4.5×4×0.84, earth yellow */}
      <mesh name="wall" position={[0, 0, 2.75]}>
        <boxGeometry args={[4.5, 4, 0.84]} />
        <meshBasicMaterial color="#a68b5b" />
      </mesh>
      ...
      <mesh name="solder_proxy" position={[0, 2.5, 2.75]}>
